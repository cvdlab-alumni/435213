...
horizontal_partition = STRUCT([floor0,floor1,floor2,floor3,floor3m,floor4,f03d,f13d,f23d,f33d])
horizontal_partition = T(2)(0.8)(horizontal_partition)
VIEW(horizontal_partition)