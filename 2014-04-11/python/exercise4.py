...
ballLampsColor = rgb2color([241,213,89])
ballLamps = COLOR(YELLOW)(ballLamps)
lamp = STRUCT([rodlamps,ballLamps])
lamps = STRUCT(NN(11)([lamp,T(2)(5)]))
...
treeLamp = larBall(1.2)([18,36])
treeLamp = STRUCT(MKPOLS(treeLamp))
treeLamp = T(3)(2.9)(treeLamp)


treeLampsColor = rgb2color([30,124,28])
treeLamp = COLOR(GREEN)(treeLamp)
tree = STRUCT([rodtree,treeLamp])
...
city = STRUCT([city,streetlines,parking,railRoads,wallRailRoad,lamps,busStop,trees,busInfo])
VIEW(city)